...
export const Login = () => {
  ...
  return (
    <div>
        <img className='sm:block hidden object-cover h-full w-full absolute' src='https://assets.nflxext.com/ffe/siteui/vlv3/1ecf18b2-adad-4684-bd9a-acab7f2a875f/4f859d52-289a-4ab5-80b4-f3db0bdf4cde/ID-en-20230116-popsignuptwoweeks-perspective_alpha_website_large.jpg'/>
            ...
            <div className='fixed w-full px-4 py-24 z-50'>
                <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white rounded-md'>
                    <div className='py-16 max-w-[300px] mx-auto'>
                        <h1 className='text-3xl font-semibold text-start pb-2'>Sign In</h1>
                        ...
                        {error ? <p className='p-3 bg-orange-400 rounded-md text-start'>{error}</p> : null}
                            ...
                            <button type='submit' className='bg-red-600 text-white font-bold p-3 rounded-sm mt-5 mb-3'>Sign In</button>
